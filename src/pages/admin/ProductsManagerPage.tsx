...
export default function ProductsManagerPage() {
  ...
  const submit = async (form: FormData) => {
    try {
      await saveProduct({
        name: String(form.get('name')).trim(), category: String(form.get('category')).trim(), label: String(form.get('label')).trim(), image_url: String(form.get('image_url')).trim(), description: String(form.get('description')).trim(),
