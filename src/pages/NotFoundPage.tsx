    ...
    <section className="editorial-section grid min-h-screen place-items-center pt-32 text-center">
      <div className="editorial-container max-w-3xl">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          <Link to="/" className="editorial-button editorial-button--primary"><Home aria-hidden="true" />{copy.home}</Link>
          <Link to="/services" className="editorial-button editorial-button--outline"><ArrowLeft aria-hidden="true" />{copy.services}</Link>
        </div>
      </div>
    </section>
  );
