      ...
      <div className="mt-12 divide-y divide-neutral-200 border-t border-neutral-200">
        {guides.map((item, index) => {
          ...
          <div className="grid gap-7 md:grid-cols-2">
            ...
            <Link to={`/portfolio/${guide.slug}/`} className="inline-flex items-center gap-2 text-sm font-semibold text-orange-600 md:col-span-2">{guide.project}<ArrowUpRight className="size-4" /></Link>
          </div>
        </article>;})}
      </div>
    </div>
