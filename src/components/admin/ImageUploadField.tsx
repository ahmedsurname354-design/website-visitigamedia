...
export function ImageUploadField({ name, label = 'Gambar', initial = '', folder, clearable = false }: { name: string; label?: string; initial?: string; folder: 'products' | 'portfolios' | 'news' | 'services'; clearable?: boolean }) {
  const inputId = useId();
