...
export default function HeroSection() {
  ...
  const backgroundScale = useTransform(scrollYProgress, [0, 1], [1.22, 1.14]);
  ...
  return (
    <section ref={sectionRef} id="home" className="hero-editorial theme-keep-light relative bg-black">
      <div className="hero-editorial__stage">
        {/* Background image */}
        <motion.div className="absolute inset-0" style={reducedMotion ? undefined : { y: backgroundY, scale: backgroundScale }}>
          <img
            src={heroImg}
        ...
        <motion.div
          ...
          animate={reducedMotion ? undefined : { scale: [1, 1.2, 1], opacity: [0.2, 0.4, 0.2] }}
          transition={{ duration: 6, repeat: Infinity }}
        />
        <motion.div
          className="absolute bottom-1/4 left-1/3 w-96 h-96 bg-orange-200/10 rounded-full blur-3xl"
          animate={reducedMotion ? undefined : { scale: [1, 1.3, 1], opacity: [0.1, 0.3, 0.1] }}
